...
const timeLineAbout = gsap.timeline({scrollTrigger:"#About-me",defaults:{duration:0.8,ease: Power1.easeInOut}})   
...
//animation Education&Skills
 const timeLineEducation = gsap.timeline({scrollTrigger:".Education-Skills-head",defaults:{duration:0.8,ease: Back.easeInOut.config(1.7)}})
 timeLineEducation.fromTo(".Education-Skills-head", {scale:0 ,rotate:-45},{scale:1,rotate:360});
 timeLineEducation.fromTo(".Education-information", {scale:0,opacity:0},{scale:1,opacity:1});
 ...
 const timeLineService = gsap.timeline({scrollTrigger:".box-part",defaults:{duration:0.3, ease: Power0.easeNone}})
 timeLineService.fromTo(".box-part1", {x:600 ,opacity:0},{x:0 ,opacity:1});
 timeLineService.fromTo(".box-part2", {y:600 ,opacity:0},{y:0 ,opacity:1});
 timeLineService.fromTo(".box-part3", {x:600 ,opacity:0},{x:0 ,opacity:1});

  //animation Portfolio
  const timeLinePortfolio = gsap.timeline({scrollTrigger:"#Portfolio",defaults:{duration:1}})
